...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # shape (N, C).                                                             #
    #############################################################################
    fc1 = X.dot(W1) + b1     #fully connected layer
    X2 = np.maximum(0, fc1)  #ReLU activation function
    scores = X2.dot(W2) + b2 #fully connected layer
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
    ...
    dW2 += reg * 2 * W2#add regularization gradient
    ...
    dW1 += reg * 2 * W1#add regularization gradient
